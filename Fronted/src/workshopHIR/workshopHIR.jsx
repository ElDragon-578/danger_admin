...
import { AlertTriangle, Calendar, User, FileText, Save, Printer } from 'lucide-react';

export function HIRworkshop() {
  ...
  const getRiskLevel = () => {
    ...
    if (score >= 240) return { level: 'Crítico', color: 'bg-red-500', textColor: 'text-red-700' };
    if (score >= 160) return { level: 'Alto', color: 'bg-orange-500', textColor: 'text-orange-700' };
    if (score >= 80) return { level: 'Medio', color: 'bg-yellow-500', textColor: 'text-yellow-700' };
        ...
        <article className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-[#F5C431] to-[#C9AA4B] text-white p-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-3xl font-bold">Hoja de Información de Riesgos</h1>
                  <p className="text-blue-100 mt-1">Registro y seguimiento de riesgos del proyecto</p>
                </div>
              </div>
          ...
          <div className="p-6 border-b border-gray-200">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div className="space-y-2">
                ...
                <input 
                  ...
                  onChange={(e) => handleInputChange('riesgoId', e.target.value)}
              ...
              <div className="space-y-2">
                ...
                <select 
                  ...
                  onChange={(e) => handleInputChange('impacto', parseInt(e.target.value))}
                  className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white"
                >
            ...
            <div className="mt-6 p-4 bg-gray-50 rounded-lg">
              <div className="flex items-center justify-between">
                <span className="text-sm font-medium text-gray-600">Nivel de Riesgo Calculado:</span>
                <div className="flex items-center gap-2">
                  <div className={`w-4 h-4 rounded-full ${riskLevel.color}`}></div>
                  <span className={`font-bold ${riskLevel.textColor}`}>{riskLevel.level}</span>
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="space-y-3">
              ...
              <textarea
                ...
                onChange={(e) => handleInputChange('refinamientoContexto', e.target.value)}
                className="w-full p-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white resize-none"
                rows="3"
            ...
            <div className="space-y-3">
              ...
              <textarea
                ...
                onChange={(e) => handleInputChange('mitigacionMonitoreo', e.target.value)}
                className="w-full p-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white resize-none"
                rows="3"
            ...
            <div className="space-y-3">
              ...
              <textarea
                ...
                onChange={(e) => handleInputChange('manejoContigencia', e.target.value)}
                className="w-full p-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white resize-none"
                rows="3"
          ...
          <div className="p-6 bg-gray-50 border-t border-gray-200">
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <label className="text-sm font-medium text-gray-600">Fecha de Estado:</label>
                  <input 
                    type="date"
                    value={formData.fechaEstado}
                    onChange={(e) => handleInputChange('fechaEstado', e.target.value)}
                    className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <input 
                    ...
                    onChange={(e) => handleInputChange('estadoActual', e.target.value)}
                    className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-3">
                ...
                <input 
                  ...
                  onChange={(e) => handleInputChange('originador', e.target.value)}
                  className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              ...
              <div className="space-y-3">
                ...
                <input 
                  ...
                  onChange={(e) => handleInputChange('asignado', e.target.value)}
                  className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          ...
          <div className="bg-gray-100 p-4 text-center">
            <p className="text-sm text-gray-600">
              Documento generado automáticamente - Sistema de Gestión de Riesgos v2.0
            </p>
          </div>
        </article>
      </div>
